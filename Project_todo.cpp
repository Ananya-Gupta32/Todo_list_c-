...
void Edit()
{
    ...
    todo td;
    // ifstream hin;
    // hin.open("Project_text_todo.txt");
    
    cout<<"Enter Task to be edited :";
    cin>>t_edit_no;
    cout<<"Write the edited task :";
    ...
    ofstream hout;
    hout.open("Project_text_todo.txt" , ios::trunc);

    //vector is 0th indexed so-
    t_edit_no--;
